...
public class CustomAnimatedAdapter extends RecyclerView.Adapter<CustomAnimatedAdapter.ViewHolder> {
    private Context context;
    private Boolean aBoolean;
    private List<String> listOfItem;

    public CustomAnimatedAdapter(Context context, Boolean aBoolean, List<String> list) {
